                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body no-padding">
                            <ul class="nav nav-pills nav-stacked">
                                <li class="active"><a href="schedule.jsp"><i class="fa fa-calendar-o"></i> Thời khóa biểu trung tâm</a></li>
                                <li><a href="schedule-lecturers.jsp"><i class="fa fa-id-card-o"></i> Thời khóa biểu giảng viên</a></li>
                            </ul>
                        </div><!-- /.box-body -->
                    </div><!-- /. box -->
                </div><!-- /.col -->
                <div class="col-md-9">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Thời khóa biểu trung tâm</h3>
                        </div>
                        <div class="box-body no-padding">
                            <!-- THE CALENDAR -->
                            <div id="calendar"></div>
