            ...
            <div class="row">
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body no-padding">
                            <ul class="nav nav-pills nav-stacked">
                                <li class="active"><a href="students.jsp"><i class="fa fa-free-code-camp"></i> Các lớp đang học</a></li>
                ...
                <div class="col-md-9">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Học viên</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body ">
                            <div class="row">
                                <div class="col-xs-12">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="badge bg-light-blue">50%</span>
                                                </td>
                                ...
                                <div class="col-xs-12 class-students">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>HV001</td>
                                            <td>Trần Tuấn Anh</td>
                                            <td><span class="badge bg-maroon-active">9</span></td>
                                            <td><span class="badge bg-maroon-active">10</span></td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox"></td>
                                            <td>2</td>
