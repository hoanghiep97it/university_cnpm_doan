                ...
                <div class="col-md-9">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <div class="has-feedback">
                                    <a href="create-course-category.jsp"><button class="btn btn-primary">Tạo mới</button></a>
                                    <a href="course-categories.jsp"><button class="btn btn-danger">Hủy</button></a>
                                </div>
                            </div><!-- /.box-tools -->
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <div class="form-group">
                                <input class="form-control" placeholder="Tên danh mục" value="Lập trình tổng quát">
                            </div>
                            <div class="form-group">
                                <input class="form-control" placeholder="Ngôn ngữ, Công nghệ, chủ đề" value="Java, C/C++,...">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="box-footer">
                            ...
                            <button class="btn btn-danger"><i class="fa fa-times"></i> Hủy</button>
                        </div><!-- /.box-footer -->
                    </div><!-- /. box -->
                </div><!-- /.col -->
            </div><!-- /.row -->
