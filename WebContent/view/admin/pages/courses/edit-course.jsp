                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <input class="form-control" placeholder="Tên kháo học" value="Lập trình C/C++ cơ bản">
                            </div>
                            <div class="form-group">
                                <input class="form-control" placeholder="Ngôn ngữ, Công nghệ, Chủ đề" value="C/C++">
                            </div>
                            <div class="form-group">
                                <select class="form-control" name="course-category" id="course-category">
                                    <option value="0">Danh mục khóa học...</option>
                                    <option value="1" selected>Lập trình tổng quát</option>
                                    <option value="2">Lập trình nhúng</option>
                            ...
                            <div class="form-group">
                                <textarea id="compose-textarea" class="form-control" style="height: 300px">
                                  <h1><u>Lập trình C/C++ cơ bản</u></h1>
                            ...
                            <ul class="mailbox-attachments clearfix">
                                <li>
                                    <div class="btn btn-default btn-file">
                                        <i class="fa fa-paperclip"></i> Đính kèm file giới thiệu
                                        <input type="file" name="attachment">
                                    </div>
                                    <div class="form-group">
                                        <input type="hidden" name="file-attachment">
                                    </div>
                                    <p class="help-block">Tối đa: 10MB</p>
                        ...
                        <div class="box-footer">
                            <div class="pull-right">
                                <button class="btn btn-default"><i class="fa fa-pencil"></i> Lưu nháp</button>
                                <button type="submit" class="btn btn-primary"><i class="fa fa-envelope-o"></i> Lưu</button>
                            </div>
                            <a href="courses.jsp"><button class="btn btn-default"><i class="fa fa-times"></i> Hủy</button></a>
                        </div><!-- /.box-footer -->
                    </div><!-- /. box -->
                </div><!-- /.col -->
            </div><!-- /.row -->
