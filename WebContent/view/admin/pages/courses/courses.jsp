                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body no-padding">
                            <ul class="nav nav-pills nav-stacked">
                                <li class="active"><a href="#"><i class="fa fa-list-ul"></i> Danh sách </a></li>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-xs-6">
                                    <a href="course-detail.jsp" class="text-primary">
                                        <div class="info-box">
                                    ...
                                    <a href="course-detail.jsp" class="text-primary">
                                        <div class="info-box">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <span class="info-box-more">Java JSP</span>
                                            </div><!-- /.info-box-content -->
                                        </div><!-- /.info-box -->
                                    </a>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-xs-6">
                                    <a href="course-detail.jsp" class="text-primary">
                                        <div class="info-box">
                                            <span class="info-box-icon bg-green"><i class="fa fa-free-code-camp"></i></span>
                                            <div class="info-box-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-xs-6">
                                    <a href="course-detail.jsp" class="text-primary">
                                        <div class="info-box">
                                            <span class="info-box-icon bg-maroon"><i class="fa fa-free-code-camp"></i></span>
                                            <div class="info-box-content">
