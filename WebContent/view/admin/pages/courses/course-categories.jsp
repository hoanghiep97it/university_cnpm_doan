                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <!--<div class="has-feedback">-->
                                    <!--<input type="text" class="form-control input-sm" placeholder="Tìm danh mục">-->
                        ...
                        <div class="box-body no-padding">
                            <div class="mailbox-controls">
                                ...
                                <a href="create-course-category.jsp"><button class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Thêm mới</button></a>
                                <div class="pull-right">
                                    1-50/200
                                    <div class="btn-group">
                            ...
                            <div class="table-responsive course-category-box">
                                <table class="table table-hover table-striped">
                                    <tbody>
                                    <tr>
                                        <td><input type="checkbox"></td>
                                        <td class="course-category-star"><a href=""><i class="fa fa-star text-yellow"></i></a></td>
                                        <td class="mailbox-name"><a href="course-category-detail.jsp">Lập trình Web</a></td>
                                        <td class="mailbox-subject"><b>Lorem Ipsum is simply dummy text of the printing</b> - Trying to find a solutTrying to find a solution to this problem...</td>
                                        <td><a href="edit-course-category.jsp"><i class="fa fa-edit text-black"></i></a></td>
                                        <td class="mailbox-date">8 tháng trước</td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox"></td>
                                        <td class="course-category-star"><a href=""><i class="fa fa-star text-yellow"></i></a></td>
                                        <td class="mailbox-name"><a href="course-category-detail.jsp">Lập trình Game</a></td>
                                        <td class="mailbox-subject"><b>Lorem Ipsum is simply dummy text of the printing</b> - Trying to find a solutTrying to find a solution to this problem...</td>
                                        <td><a href="edit-course-category.jsp"><i class="fa fa-edit text-black"></i></a></td>
                                        <td class="mailbox-date">8 tháng trước</td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox"></td>
                                        <td class="course-category-star"><a href=""><i class="fa fa-star text-yellow"></i></a></td>
                                        <td class="mailbox-name"><a href="course-category-detail.jsp">Lập trình Nhúng</a></td>
                                        <td class="mailbox-subject"><b>Lorem Ipsum is simply dummy text of the printing</b> - Trying to find a solutTrying to find a solution to this problem...</td>
                                        <td><a href="edit-course-category.jsp"><i class="fa fa-edit text-black"></i></a></td>
                                        <td class="mailbox-date">8 tháng trước</td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox"></td>
                                        <td class="course-category-star"><a href=""><i class="fa fa-star text-yellow"></i></a></td>
                                        <td class="mailbox-name"><a href="course-category-detail.jsp">Đồ họa</a></td>
                                        <td class="mailbox-subject"><b>Lorem Ipsum is simply dummy text of the printing</b> - Trying to find a solutTrying to find a solution to this problem...</td>
                                        <td><a href="edit-course-category.jsp"><i class="fa fa-edit text-black"></i></a></td>
                                        <td class="mailbox-date">8 tháng trước</td>
                                    </tr>
...
<script>
    $(function () {
        ...
        $('.course-category-box input[type="checkbox"]').iCheck({
        ...
        $(".checkbox-toggle").click(function () {
            ...
            if (clicks) {
                ...
                $(".course-category-box input[type='checkbox']").iCheck("uncheck");
                $(".fa", this).removeClass("fa-check-square-o").addClass('fa-square-o');
            } else {
                //Check all checkboxes
                $(".course-category-box input[type='checkbox']").iCheck("check");
        ...
        $(".course-category-star").click(function (e) {
            e.preventDefault();
            //detect type
