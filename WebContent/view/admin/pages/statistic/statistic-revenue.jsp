            ...
            <div class="row">
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body no-padding">
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="statistic-online.jsp"><i class="fa fa-line-chart"></i> Lượt truy cập</a></li>
                                <li class="active"><a href="statistic-revenue.jsp"><i class="fa fa-pie-chart"></i> Doanh thu</a></li>
                ...
                <div class="col-md-9">
                    <div class="box box-danger">
                        <div class="box-header with-border">
                            <h3 class="box-title">Phần trăm doanh thu</h3>
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Khóa C/C++ cơ bản</h3>
                            <div class="box-tools pull-right">
                                <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                                <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                            </div>
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Khóa C/C++ nâng cao</h3>
                            <div class="box-tools pull-right">
                                <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                                <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                            </div>
    ...
    $(function () {
        ...
        var PieData = [
            ...
            },
            {
                ...
                color: "#3c8dbc",
                highlight: "#3c8dbc",
                label: "Thiết kế giao diện website với Photoshop"
            },
            {
                value: 30,
                color: "#d2d6de",
                highlight: "#d2d6de",
                label: "Thiết kế website với Bootstrap 4"
            }
        ];
        var pieOptions = {
         ...
         */
        var areaChartData = {
            labels: ["Đợt 1", "Đợt 2", "Đợt 3", "Đợt 4", "Đợt 5", "Đợt 6", "Đợt 7"],
            datasets: [
                {
                    label: "Digital Goods",
