...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-3">
                    <a href="create-class.jsp" class="btn btn-primary btn-block margin-bottom">Chiêu sinh lớp mới</a>
                    <div class="box box-solid">
                        ...
                        <div class="box-body no-padding">
                            <ul class="nav nav-pills nav-stacked">
                                <li class="active"><a href="classes.jsp"><i class="fa fa-free-code-camp"></i> Lớp học đang mở</a></li>
