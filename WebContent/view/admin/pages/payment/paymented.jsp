            ...
            <div class="row">
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body no-padding">
                            <ul class="nav nav-pills nav-stacked">
                                <li class="active"><a href="paymented.jsp"><i class="fa fa-money"></i> Danh sách đã thanh toán</a></li>
                ...
                <div class="col-md-9">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Danh sách đã thanh toán</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                                <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <table class="table table-bordered">
                                        <tbody>
                                        <tr>
                                            <th style="width: 10px">Mã thanh toán</th>
                                            <th>Mã giảng viên</th>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-blue-active">10</span></td>
                                            <td><span class="badge bg-maroon-gradient">10</span></td>
                                            <td><span class="badge bg-aqua-active">10</span></td>
                                            <td><span class="badge bg-aqua-active">10.000.000</span></td>
                                            <td><span class="badge bg-aqua-active">10.000.000</span></td>
                                            <td><span class="badge bg-maroon-gradient">10.000.000</span></td>
                                            <td><span class="badge bg-aqua-active">10.000.000</span></td>
                                        </tr>
                                        <tr>
                                            <td>P0001</td>
