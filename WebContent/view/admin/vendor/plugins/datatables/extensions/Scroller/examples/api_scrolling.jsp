				...
				<div class="toc">
					<div class="toc-group">
						...
						<ul class="toc active">
							...
							<li><a href="./state_saving.jsp">State saving</a></li>
							<li><a href="./large_js_source.jsp">Client-side data source (50,000 rows)</a></li>
							<li><a href="./server-side_processing.jsp">Server-side processing (5,000,000
							rows)</a></li>
							<li class="active"><a href="./api_scrolling.jsp">API</a></li>
						</ul>
					</div>
				</div>
