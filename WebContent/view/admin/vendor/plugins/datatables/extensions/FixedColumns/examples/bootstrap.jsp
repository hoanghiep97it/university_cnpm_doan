			...
			<div class="liner">
				...
				<div class="toc">
					<div class="toc-group">
						...
						<ul class="toc active">
							<li><a href="./left_right_columns.jsp">Left and right fixed columns</a></li>
							<li><a href="./simple.jsp">Basic initialisation</a></li>
							<li><a href="./two_columns.jsp">Multiple fixed columns</a></li>
							<li><a href="./right_column.jsp">Right column only</a></li>
							<li><a href="./rowspan.jsp">Complex headers</a></li>
							<li><a href="./colvis.jsp">ColVis integration</a></li>
							<li><a href="./server-side-processing.jsp">Server-side processing</a></li>
							<li><a href="./css_size.jsp">CSS row sizing</a></li>
							<li><a href="./size_fixed.jsp">Assigned column width</a></li>
							<li><a href="./size_fluid.jsp">Fluid column width</a></li>
							<li><a href="./col_filter.jsp">Individual column filtering</a></li>
							<li class="active"><a href="./bootstrap.jsp">Bootstrap</a></li>
							<li><a href="./index_column.jsp">Index column</a></li>
						</ul>
					</div>
				</div>
