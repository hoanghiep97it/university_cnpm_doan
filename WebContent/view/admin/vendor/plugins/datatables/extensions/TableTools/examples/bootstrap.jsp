	...
	<div class="container">
		<section>
			...
			<div class="info">
				...
				<p>This example shows the default Bootstrap theme being used with a Bootstrap styled DataTable. The <a href="new_init.jsp"><code>new</code></a> form of
			...
			<div class="liner">
				...
				<div class="toc">
					<div class="toc-group">
						...
						<ul class="toc active">
							<li><a href="./simple.jsp">Basic initialisation</a></li>
