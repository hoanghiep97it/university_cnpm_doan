				...
				<div class="toc">
					<div class="toc-group">
						...
						<ul class="toc active">
							...
							<li><a href="./new_init.jsp">`new` initialisation</a></li>
							<li><a href="./text.jsp">Custom button text</a></li>
							<li><a href="./exclude_columns.jsp">Exclude columns from list</a></li>
							<li><a href="./title_callback.jsp">Column button callback</a></li>
							<li><a href="./button_order.jsp">Button ordering</a></li>
							<li><a href="./mouseover.jsp">Mouseover activation</a></li>
							<li class="active"><a href="./group_columns.jsp">Group columns</a></li>
							<li><a href="./two_tables.jsp">Two tables with individual controls</a></li>
							<li><a href="./two_tables_identical.jsp">Two tables with shared controls</a></li>
							<li><a href="./restore.jsp">Restore / show all</a></li>
