				...
				<div class="toc">
					<div class="toc-group">
						...
						<ul class="toc active">
							...
							<li><a href="./columns.jsp">Column options</a></li>
							<li><a href="./scrolling.jsp">Scrolling DataTable</a></li>
							<li><a href="./fill-both.jsp">Horizontal and vertical fill</a></li>
							<li><a href="./fill-horizontal.jsp">Horizontal fill</a></li>
							<li><a href="./complete-callback.jsp">Complete callback</a></li>
							<li class="active"><a href="./step-callback.jsp">Step callback</a></li>
						</ul>
					</div>
				</div>
