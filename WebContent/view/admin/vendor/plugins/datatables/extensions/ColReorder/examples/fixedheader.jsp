				...
				<div class="toc">
					<div class="toc-group">
						...
						<ul class="toc active">
							...
							<li><a href="./new_init.jsp">Initialisation using `new`</a></li>
							<li><a href="./alt_insert.jsp">Alternative insert styling</a></li>
							<li><a href="./realtime.jsp">Realtime updating</a></li>
							<li><a href="./state_save.jsp">State saving</a></li>
							<li><a href="./scrolling.jsp">Scrolling table</a></li>
							<li><a href="./predefined.jsp">Predefined column ordering</a></li>
							<li><a href="./reset.jsp">Reset ordering API</a></li>
							<li><a href="./colvis.jsp">ColVis integration</a></li>
							<li><a href="./fixedcolumns.jsp">FixedColumns integration</a></li>
							<li class="active"><a href="./fixedheader.jsp">FixedHeader integration</a></li>
							<li><a href="./jqueryui.jsp">jQuery UI styling</a></li>
							<li><a href="./col_filter.jsp">Individual column filtering</a></li>
							<li><a href="./server_side.jsp">Server-side processing</a></li>
						</ul>
					</div>
				</div>
